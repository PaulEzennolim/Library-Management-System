...
public class RemoveStaff extends javax.swing.JFrame {
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        // Get the input value from the text field 't1'. The data type of NAME and STAFF_ID is varchar.
        String input = t1.getText();
        // Define the SQL query to delete a staff based on its ID or name
        ...
        try {
            ...
            */
            ...
            /*
            If no rows were affected (rows == 0), the input did not match any existing staff_id or name in the table.
            Display a message indicating that no such staff is present.
            */
            } else {
